--Gabriela, Eric, Lucero, kevin, Ricardo
...
-- *Gabriela Estrada* —---------------------------------------------------------------------------------------
-- 1) Obtener la lista de usuarios que han recibido una notificación específica.
...
-- 2) Obtener el promedio de temperatura para un distrito en un rango de fechas.
...
-- 3) Obtener el nombre de los distritos que tienen al menos una alerta activa.
...
-- *Eric Cuevas* —-----------------------------------------------------------------------------------------------
-- 1) Obtener los distritos junto con la cantidad de usuarios que pertenecen a estos 
...
-- 2) Devolver la tabla de los eventos climaticos a partir del id de un TipoEvento ingresado (funcion) 
...
-- 3) Mostrar todas las notificaciones en un rango de fechas para un usuario cuyo id es ingresado (procedure) 
...
-- *Kevin Arce* —------------------------------------------------------------------------------------------------
-- 1)Obtener la cantidad de reportes y el nivel de urgencia por cada distrito
SELECT
    D.idDistrito,
...
-- 2)FUNCION PARA Obtener todos los usuarios con su respectivo método de pago:
...
-- 3) PROCEDURE para Obtener todos los métodos de prevención y tipo de evento climático dependiendo del tipo de alerta y estado
...
-- 1) Obtener el nombre de los distritos, id evento, grado y descripción de los que tienen al menos un evento climático venidero activo (Simple).
...
-- 2) Función para obtener a los usuarios dependiendo de la provincia a la que pertenece.
...
-- 3) Muestra datos relevantes de pronóstico meteorológico y reporte clima en el transcurso del tiempo solicitado.
